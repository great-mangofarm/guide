  ...
  return (
    <DocsLayout>
      ...
      <div className="mt-8 space-y-6">
        ...
        <section>
          <Typography variant='h4' className="pb-1" id="epc-principles">1. EPC 기본 원칙 </Typography>
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="process-management">1.1 전체 프로세스의 1:1:1 관리</Typography>
          ...
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="step-completion">1.2 업무 단계별 완료 의무화</Typography>
          ...
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="data-integration">1.3 데이터 연동 기반 업무 처리</Typography>
        ...
        <section>
          <Typography variant='h4' className="pb-1" id="menu-changes">2. 주요 메뉴 및 프로세스 변경점 </Typography>
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="process-order-change">2.1 프로세스 순서 변경</Typography>
          ...
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="menu-restructure">2.2 메뉴 구조 개편</Typography>
          ...
          <div className='py-1.5'>
            <Typography variant='h5' className="pb-1" id="data-integration-process">2.3 데이터 연동 기반 업무 처리</Typography>
            <Typography variant='small' className="p-0.25">• 모든 단계에서 실시간 데이터 동기화</Typography>
            <Typography variant='small' className="p-0.25">• 중간 데이터 누락 시 프로세스 진행 불가</Typography>
          </div>
        </section>
